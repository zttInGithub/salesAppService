 ...
 **/
@Entity
@Table(name = "CHECK_MICRO_PROFITTEMPLATE")
public class CheckMicroProfittemplateModel {
    @Id
    @Column(name = "APTID")
    @SequenceGenerator(name = "S_CHECK_MICRO_PROFITTEMPLATE", sequenceName = "S_CHECK_MICRO_PROFITTEMPLATE",allocationSize = 1)
    @GeneratedValue(generator = "S_CHECK_MICRO_PROFITTEMPLATE",strategy = GenerationType.SEQUENCE)
	...
	public CheckMicroProfittemplateModel() {
    }
