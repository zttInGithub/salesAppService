...
@Entity
@Table(name = "BILL_MERCHANTTERMINALINFO")
public class MerchantTerminalInfoModel implements Serializable{
	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -2713481544430614845L;

	@Id
	@SequenceGenerator(name = "S_BILL_MERCHANTTERMINALINFO1", sequenceName = "S_BILL_MERCHANTTERMINALINFO",allocationSize = 1)
	@GeneratedValue(generator = "S_BILL_MERCHANTTERMINALINFO1",strategy = GenerationType.SEQUENCE)
	@Column(name = "BMTID")	
	...
	@Column(name = "INSTALLEDSIM")
	private String installedSIM;		//sim卡
	
	@Column(name = "DEPOSITFLAG")
