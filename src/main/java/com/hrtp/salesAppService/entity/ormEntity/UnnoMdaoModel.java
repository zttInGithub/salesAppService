 ...
 **/
@Entity
@Table(name = "PG_UNNOMDAO_FENRUN")
public class UnnoMdaoModel implements Serializable{
    private static final long serialVersionUID = 1L;
    @Id
    @Column(name = "UMDFRID")
    private Integer umdfrId;
    @Column(name = "TXNTYPE")
    ...
    public UnnoMdaoModel(){}

    public UnnoMdaoModel(Double txnAmt,Double txnProfit,Integer txnType,Double cashProfit){
        this.txnAmt = txnAmt;
    ...
    public Integer getUmdfrId() {
        return umdfrId;
    }

    public void setUmdfrId(Integer umdfrId) {
        this.umdfrId = umdfrId;
    }
